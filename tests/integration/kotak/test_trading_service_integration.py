...
def main():
    ...
    parser.add_argument(
        "--skip-init", action="store_true", help="Skip initialization (use existing session)"
    )
    parser.add_argument(
    ...
    service = TestTradingService(env_file=args.env, force_trading_day=not args.no_force_trading_day)
