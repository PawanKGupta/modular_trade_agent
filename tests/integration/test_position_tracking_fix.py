                        ...
                        if i != j:
                            ...
                            if other_entry < exit_date:
                                ...
                                if not other_pos.get('is_pyramided', False):
                                    ...
                                    other_exit = pd.to_datetime(other_pos['exit_date']) if other_pos.get('exit_date') else None
            ...
            for i in range(len(positions_sorted) - 1):
                ...
                if pos1_exit:
                    if pos1_exit <= pos2_entry:
                        ...
                        print(f"✅ Position {i+1} exits on/before Position {i+2} enters - correctly NOT pyramided")
                    else:
