...
class TestMLInclusionLogic:
    ...
    def test_ml_buy_rule_watch_included(self):
        ...
        assert "[WARN]? ONLY ML" in msg, "Should show ONLY ML indicator when rule=watch but ML=buy"
    ...
    def test_ml_strong_buy_rule_avoid_included(self):
        ...
        assert (
            "[WARN]? ONLY ML" in msg
        ), "Should show ONLY ML indicator when rule=avoid but ML=strong_buy"
    ...
    def test_ml_watch_rule_buy_included(self):
        ...
        # Verify disagreement indicator
        assert (
            "[WARN]? ONLY RULE" in msg
        ), "Should show ONLY RULE indicator when rule=buy but ML=watch"
    ...
    def test_ml_buy_rule_buy_agreement(self):
        ...
        assert "[WARN]?" not in msg, "Should NOT show disagreement indicator when agreeing"
