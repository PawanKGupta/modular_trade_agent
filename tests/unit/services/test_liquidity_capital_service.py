...
spec = importlib.util.spec_from_file_location(
    "liquidity_capital_service",
    str(project_root / "services" / "liquidity_capital_service.py")
)
...
class TestLiquidityCapitalService:
    ...
    def test_calculate_max_capital_high_liquidity(self):
        ...
        # High liquidity: 5M volume, ₹2500 price
    ...
    def test_calculate_max_capital_medium_liquidity(self):
        ...
        # Medium liquidity: 100K volume, ₹500 price
        max_capital = service.calculate_max_capital(
            avg_volume=100000,
            stock_price=500
        )
    ...
    def test_calculate_max_capital_low_liquidity(self):
        ...
        # Low liquidity: 5K volume, ₹50 price
        max_capital = service.calculate_max_capital(
            avg_volume=5000,
            stock_price=50
        )
    ...
    def test_is_capital_safe_high_liquidity(self):
        ...
        is_safe = service.is_capital_safe(
            user_capital=200000,
            avg_volume=5000000,
            stock_price=2500
        )
    ...
    def test_edge_case_very_high_price(self):
        ...
        result = service.calculate_execution_capital(
            avg_volume=100000,
            stock_price=100000  # Very high price
        )
    ...
    def test_minimum_absolute_volume_check(self):
        ...
        result = service.calculate_execution_capital(
            avg_volume=1000,  # Below MIN_ABSOLUTE_AVG_VOLUME (20000)
            stock_price=50
        )
    ...
    def test_calculate_execution_capital_max_cap_zero_from_calculation(self):
        ...
        result = service.calculate_execution_capital(
            avg_volume=100,  # Very low
            stock_price=0.01  # Very low price
        )
    ...
    def test_calculate_execution_capital_exception_path(self):
        ...
        from unittest.mock import patch
        with patch.object(service, 'calculate_max_capital', side_effect=Exception("Test exception")):
            result = service.calculate_execution_capital(
                avg_volume=1000000,
                stock_price=100
            )
