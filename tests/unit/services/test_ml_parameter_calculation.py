...
class TestMLParameterCalculation:
    ...
    @patch('core.analysis.calculate_smart_buy_range')
    @patch('core.analysis.calculate_smart_stop_loss')
    @patch('core.analysis.calculate_smart_target')
    def test_calculates_params_from_last_close(
        ...
        # Act
        results = service.add_backtest_scores_to_results([mock_stock_result_with_last_close])
    ...
    def test_calculates_params_from_prefetched_df(
        ...
        # Act
        results = service.add_backtest_scores_to_results([mock_stock_result_with_prefetched_df])
    ...
    def test_calculates_params_from_stock_info(
        ...
        # Act
        results = service.add_backtest_scores_to_results([mock_stock_result_with_stock_info])
    ...
    def test_sets_none_when_no_price_available(self, mock_backtest, mock_stock_result_no_price):
        ...
        # Act
        results = service.add_backtest_scores_to_results([mock_stock_result_no_price])
    ...
    def test_handles_rule_approved_ml_approved_signals(self, mock_backtest):
        ...
        # Act
        results = service.add_backtest_scores_to_results([stock_result])
