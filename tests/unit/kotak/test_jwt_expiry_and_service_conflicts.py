...
class TestForceReloginCreatesNewClient(unittest.TestCase):
    ...
    def test_force_relogin_always_creates_new_client(self, mock_load_dotenv, mock_neo_api_class):
        ...
        with patch.dict('os.environ', {
            ...
            initial_client_id = id(auth.client)
...
class TestServiceConflictDetection(unittest.TestCase):
    ...
    @patch('modules.kotak_neo_auto_trader.utils.service_conflict_detector.check_old_services_running')
    @patch('modules.kotak_neo_auto_trader.utils.service_conflict_detector.stop_old_services_automatically')
    ...
    def test_prevent_conflict_no_auto_stop(self, mock_check):
        ...
        result = prevent_service_conflict("run_trading_service.py", is_unified=True, auto_stop=False)
        
        self.assertFalse(result, "Should fail if conflicts exist and auto_stop=False")
    
    @patch('modules.kotak_neo_auto_trader.utils.service_conflict_detector.check_unified_service_running')
