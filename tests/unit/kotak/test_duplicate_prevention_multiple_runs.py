...
class TestDuplicatePreventionMultipleRuns:
    ...
    def test_place_new_entries_skips_when_order_exists_in_db(self, auto_trade_engine):
        ...
        auto_trade_engine._check_for_manual_orders = MagicMock(return_value={"has_manual_order": False})
        
        # Mock indicators
        auto_trade_engine.get_daily_indicators = MagicMock(
            return_value={
                "close": 2500.0,
                "rsi10": 25.0,
                "ema9": 2600.0,
    ...
    def test_place_new_entries_allows_when_no_order_in_db(self, auto_trade_engine):
        ...
        auto_trade_engine.get_affordable_qty = MagicMock(return_value=20)
        auto_trade_engine.get_available_cash = MagicMock(return_value=100000.0)
    ...
    def test_place_new_entries_skips_pending_execution_order(self, auto_trade_engine):
        ...
        # Verify order was NOT placed
        if hasattr(auto_trade_engine, "_attempt_place_order"):
            assert not auto_trade_engine._attempt_place_order.called
