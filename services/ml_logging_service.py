...
class MLLoggingService:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_confidence": (
                self.metrics["confidence_sum"] / ml_predictions if ml_predictions > 0 else 0.0
            ),
    ...
    def generate_report(self) -> str:
        ...
        report.append(
            f"  ML Used: {metrics['ml_predictions_used']} ({metrics['ml_usage_rate']:.1%})"
        )
    ...
    def detect_drift(self, baseline_metrics: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if not baseline_metrics:
            return {"drift_detected": False, "message": "No baseline metrics provided"}
