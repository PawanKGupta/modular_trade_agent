...
def test_jwt_expiry_and_reauth():
    ...
    try:
        ...
        print(
            f"   [OK] Initial login successful (login calls: {initial_login_count}, 2FA calls: {initial_2fa_count})"
        )
...
def test_reauth_loop_fixed():
    ...
    try:
        ...
        for scenario_name, description in scenarios:
            ...
            print(f"    [OK] Handled {description} without AttributeError")
            ...
            print(f"    [OK] Re-auth handled {description} without AttributeError")
...
def test_reauth_loop_simulation():
    ...
    try:
        ...
        assert result == True, "Initial login should succeed"
        print(
            f"   [OK] Login successful (login calls: {mock_client.login_count}, 2FA calls: {mock_client.session_2fa_count})"
        )
...
def test_multiple_reauth_attempts():
    ...
    try:
        ...
        for i in range(5):
            ...
            print(f"    [OK] Re-auth {i+1} successful")
