...
class BrokerResponseNormalizer:
    ...
    @classmethod
    def _extract_field(cls, data: Dict[str, Any], field_names: List[str], default: Any = None) -> Any:
        """
    ...
    def get_transaction_type(cls, order: Dict[str, Any]) -> str:
        ...
        return str(cls._extract_field(order, cls.ORDER_FIELD_MAPPING['transaction_type'], '')).upper()
