...
**End-user help (web):** Operators should point users to the in-app help center at **`/help`** (public, no login required). It covers onboarding, broker API setup, connecting a broker, performance fees, and FAQ — without developer or GitHub documentation.
...
**Available Services:**
- **Unified Service:** Runs all tasks automatically on schedule
- **Individual Services:**
  ...
  - `sell_monitor` - Monitor positions and execute sell orders
