...
**See:** `../internal/MIGRATION_GUIDE_PHASE4.md` for detailed migration guide
...
- `../internal/` - Phase documentation (see internal folder)
- `../internal/` - Phase documentation (see internal folder)
- `../internal/MIGRATION_GUIDE_PHASE4.md` - Migration guide
