...
## Bulk / overnight analysis (Phase 0)

For large `trade_agent.py --backtest` runs, use the **reliability profile** in
...
python scripts/bulk_backtest_all_stocks.py --max-stocks 500 --years-back 25
