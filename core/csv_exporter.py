...
class CSVExporter:
    ...
    def flatten_analysis_data(self, analysis_result):
        ...
        try:
            ...
            # ML prediction (2025-11-11): Add ML monitoring data
            flattened['ml_verdict'] = analysis_result.get('ml_verdict', '')
            flattened['ml_confidence'] = analysis_result.get('ml_confidence', '')
