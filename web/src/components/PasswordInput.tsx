	...
	return (
		<div className={clsx('relative', wrapperClassName)}>
			<input
				...
				className={clsx('pr-11', className, disabled && 'opacity-60 cursor-not-allowed')}
			/>
			<button
				type="button"
				...
				disabled={disabled}
				className={clsx(
					'absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded min-h-[32px] min-w-[32px] flex items-center justify-center',
					disabled
